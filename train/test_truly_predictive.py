...
print(f"   - Using only game situation, historical stats, and player characteristics")
print(f"   - NO information about the current pitch's physics, location, or outcome")
print(f"   - This is the true test of predictive power!") 